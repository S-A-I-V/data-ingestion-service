...
export default function PolicyTable({ policies, editMode, onPolicyChange }: Props) {
  ...
  return (
    <div className="preview-table-wrap" style={{ overflowX: "auto" }}>
      <table className="data-table" style={{ minWidth: TABLE_MIN_WIDTH_PX, fontSize: 11, tableLayout: "fixed" }}>
        <thead>
          <tr>
            <th style={{ width: 110 }}>Day</th>
            <th style={{ width: 80 }}>Frequency</th>
            <th style={{ width: 110 }}>Start Time</th>
            <th style={{ width: 110 }}>SLA Time</th>
            <th style={{ width: 110 }}>Expected</th>
            <th style={{ width: 120 }}>Timezone</th>
            <th style={{ width: 60 }}>+Start</th>
            <th style={{ width: 60 }}>+SLA</th>
            <th style={{ width: 60 }}>DDF</th>
            <th style={{ width: 130 }}>Window</th>
            <th style={{ width: 60 }}>W.Start</th>
            <th style={{ width: 60 }}>W.End</th>
            <th style={{ width: 120 }}>Anchor</th>
          </tr>
        </thead>
        <tbody>
          {policies.map((p) => (
