...
/**
 * buttonVariants — CVA variant definitions for the Button component.
 * Kept in a separate .ts file (not .tsx) so Vite Fast Refresh
 * doesn't complain about non-component exports in .tsx files.
 */
