/**
 * Pill — colored status badge for delay_status or job delivery status.
 * Reused in OverviewTab, JobsTab, TimelineTab, and the main page.
 */
...
export default function Pill({ status, type = "delay" }: Props) {
  const meta =
    type === "job"
