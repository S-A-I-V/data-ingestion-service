 ...
 *
 * Deployed to: nfc-preprod application → display_code "nfc-admin"
 * URL in MAF:  https://nfc-preprod.dev.apps.nielsen.com/nfc-preprod/nfc-admin
 */
...
const NfcAdminScreen: React.FC = () => {
  ...
  const basename = "/nfc-preprod/nfc-admin";
